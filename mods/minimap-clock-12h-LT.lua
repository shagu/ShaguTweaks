...
local module = ShaguTweaks:register({
  title = "MiniMap Clock - 12h Local Time",
  description = "Adds a small 12h clock to the MiniMap showing Local Time.",
...
module.enable = function(self)
  ...
  MinimapClock:SetScript("OnUpdate", function()    
    -- Show Local Time in 12h Format in clock display
